...
//
// FOR IMAGE
// <img class="pc" data-scr="" rel="js-lazy"
// <img class="sp" data-scr="" rel="js-lazy"
// <picture>
  ...
  document
    ...
    .forEach(function (elem) {
      ...
      if (elem.hasAttribute("data-ll-status")) {
        elem
          .removeAttribute("data-ll-status")
          .classList.remove("entered loaded");
      }
    });
  callback();
}
