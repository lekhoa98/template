...
// FOR ONCA PROJECTS
// ▼▼▼▼▼ START disable manual upgrade wordpress ▼▼▼▼▼
...
// ▲▲▲▲▲ FINISH disable manual upgrade wordpress ▲▲▲▲▲
...
{
  echo '<style type="text/css">h1 { height:180px !important; } h1 a { background: url(' . get_bloginfo('template_directory') . '/images/logoanya.jpeg) no-repeat !important; width:100% !important; height: 180px !important; background-size: cover !important}</style>';
}
